<template>
  <div id="home">
    <div class="lg:flex justify-between items-center mb-6 mt-16">
      <p class="text-2xl font-semibold mb-2 lg:mb-0 dark:text-white">{{ $t('home.good_afternoon,_amr') }}!</p>
      <TodayDeal />
    </div>

    <div class="flex flex-wrap -mx-3 mb-20">
      <div class="w-1/2 xl:w-1/4 px-3">
        <div class="w-full bg-white dark:bg-gray-100 border text-blue-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
          <svg class="w-16 h-16 fill-current me-4 hidden lg:block" viewBox="0 0 20 20">
            <path
      ...
      <div class="w-1/2 xl:w-1/4 px-3">
        <div class="w-full bg-white dark:bg-gray-100 border text-blue-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0">
          ...
          <div class="text-gray-700">
            ...
            <p>{{ $t('home.product_reviews') }}</p>
          </div>
        </div>
      </div>

      <div class="w-1/2 xl:w-1/4 px-3">
        <div class="w-full bg-white dark:bg-gray-100 border text-blue-400 rounded-lg flex items-center p-6">
          <svg class="w-16 h-16 fill-current me-4 hidden lg:block" viewBox="0 0 20 20">
            <path
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 dark:text-white">{{ $t('home.recent_sales') }}</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 dark:text-white">{{ $t('home.recent_reviews') }}</p>
        <div class="w-full bg-white border rounded-lg p-4 mb-8 xl:mb-0">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4 dark:text-white">{{ $t('home.recent_transactions') }}</p>
...
export default {
  ...
  methods: {
    ...
    getCartItems() {
      ...
      this.orders.forEach((order) => {
        order.cartItems.forEach((item) => {
          ...
          if (cartItems.indexOf(item) != -1) {
            let indx = cartItems.indexOf(item)
            return cartItems[indx].cartQty + item.cartQty
          } else {
      ...
      this.reviewsData.data.datasets = cartItems
      this.buyersData.data.datasets = cartItems
