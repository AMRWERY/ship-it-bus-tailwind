<template>
  <div id="home">
    <div class="lg:flex justify-between items-center mb-6 mt-16">
      <p class="text-2xl font-semibold mb-2 lg:mb-0">{{ $t('home.good_afternoon,_amr') }}!</p>
      <TodayDeal />
    </div>
    ...
    <div class="flex flex-wrap -mx-3">
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">{{ $t('home.recent_sales') }}</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">{{ $t('home.recent_reviews') }}</p>
      ...
      <div class="w-full xl:w-1/3 px-3">
        <p class="text-xl font-semibold mb-4">{{ $t('home.recent_transactions') }}</p>
