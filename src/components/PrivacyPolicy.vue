        ...
        <div class="relative px-4 sm:px-6 lg:px-8">
            <div
                ...
                <p>All purchases made through the Website are processed by a third party payment processor, Paddle
                    (<router-link to="">paddle.com</router-link>). Paddle may ask you for personal and/or non-personal
                    information, such as your name, address, email address, credit card information, or other Personal
                    Information. Paddle has a privacy policy (<router-link to="">paddle.com/legal-buyers/</router-link>)
                    that describes their collection and use of personal information. Tailwind does not control Paddle or its
                    collection or use of information. Any questions or concerns about Paddle’s practices should be directed
                    to Paddle.</p>
                ...
                <p>Any requests to exercise User rights can be directed to the Owner by email at <router-link
                        to="">support@tailwindui.com</router-link>. These requests can be exercised free of charge and will
                ...
                <p>In particular, as noted above, purchases made through the Website are handled by Paddle and all such
                    ...
                    under the control of Paddle. We encourage purchasers to read Paddle’s Privacy Policy (<router-link
                        to="">paddle.com/legal-buyers/</router-link>).</p>
                ...
                <h2>Contacting us</h2>
                <p>If you have any questions about this Policy, please contact us by email at <router-link
                        to="">support@tailwindui.com</router-link>.</p>
            </div>
        </div>
    </div>
</template>
